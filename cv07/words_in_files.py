...
spark = SparkSession.builder \
    .appName("CountWordsFiles").getOrCreate()

accessLines = spark.readStream.text("/files/data")

words = accessLines.select(F.explode(F.split(F.lower(accessLines.value), " ")).alias("word"))
